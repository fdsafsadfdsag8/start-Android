...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator alp=ObjectAnimator.ofFloat(target,"alpha",1f,0.5f);
        alp.setRepeatCount(ValueAnimator.INFINITE);
        alp.setInterpolator(new LinearInterpolator());
        alp.setDuration(1000);
        alp.setRepeatMode(ValueAnimator.REVERSE);
        //alp.start();

        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,animatorSet1,alp);
        animatorSet.start();
    }
}
